    ...
    .then((pokemons) => {
        pokemons.results.map(pokemon => {
            ...
            .then((pokemonsDetails) => {
                fetch(`https://pokeapi.co/api/v2/pokemon-species/${pokemonsDetails.id}/`)
                .then(response => response.json())
                .then(pokemonsSpeciesDetails => {
                    ...
                    let paragraph = addParagraphe(pokemonsSpeciesDetails.names[value].name);
                    ...
                    pokemonsDetails.types.map(typeOfPokemon =>{
                        ...
                        .then((typeOfPokemonDetails) => {
                            let pokeType = addParagraphe(typeOfPokemonDetails.names[value].name);
